...
## 8. Kết luận
Chương trình giúp củng cố kiến thức Java Core và rèn luyện kỹ năng xây dựng một ứng dụng console hoàn chỉnh, có tổ chức code rõ ràng, xử lý lỗi tốt và đảm bảo dữ liệu an toàn thông qua việc lưu trữ file.
